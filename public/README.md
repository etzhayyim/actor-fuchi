...
1. **L0 enroll disclosure** — draft vow → triple CID stubs → L0 entitlement → public-person facts (`l0_enroll`).
...
- displacement L0 held-stress embed (stale disclosure → ladder refuse; carried into tenure)
